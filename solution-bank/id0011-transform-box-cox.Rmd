...
```
The random samples (`z_sim`) from the normal distribution have a density which is somewhat bell-shaped. However, it does look less normal than the data we transformed. This is a problem to be aware of in small sized data since empirical estimates (such as KDEs) may have imperfections.
