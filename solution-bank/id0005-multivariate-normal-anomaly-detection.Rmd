...
```{r sols-id0005-chi-sq-density,  fig.margin = TRUE, fig.cap = "Chi-square distribution with df=3. Area with 0.01 probability of occuring in red.", fig.width=3.5, fig.height=3.5, cache=FALSE}
