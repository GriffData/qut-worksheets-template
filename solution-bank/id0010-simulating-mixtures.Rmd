...
```{r sim-mix-,  fig.margin=TRUE, fig.width=4, fig.height=4, cache=FALSE, eval = TRUE, echo=TRUE, fig.cap= "Histogram of Poisson mixture distribution with two components and density overlayed."}
