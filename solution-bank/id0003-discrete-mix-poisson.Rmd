...
(b) The expectation and variance are
    ...
    - Expectation: $E(Z) = E(XY_{1} + (1-X)Y_{2}) =  E(X)E(Y_{1}) + (1-E(X))E(Y_{2}) = p \lambda_{1} + (1-p)\lambda_{2}$ by linearity of the expectaiton and indepedence between $X$, $Y_{1}$, $Y_{2}$.
