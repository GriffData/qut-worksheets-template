...
Three measurements (weight, rigidity, volume) of each life boat are recorded and sent to you to analyse. Suppose the measurements are assumed to follow a multivariate normal distribution with mean and variance given in the `R` code below. 
